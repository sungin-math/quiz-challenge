...
7. `통계` 에서 시즌 요약을 보고, 드롭다운으로 시즌을 고르면 문제별·학생별 표가 그 시즌 기준으로 바뀝니다.

**학생**
1. 사이트에 접속해 이름을 입력하고 시작. 이름은 **한 번만** 입력하면 모든 시즌에서 그대로 쓰입니다.
2. 시즌을 고르면 그 시즌의 문제 목록이 나옵니다. 지난 시즌도 공개돼 있으면 계속 복습할 수 있습니다.
3. 문제를 골라 답을 제출하면 즉시 정답 여부가 표시됩니다. 오답이면 계속 다시 풀 수 있습니다.
4. `내 기록` 에서 시즌별 진행률을 보고, **이어하기 코드**를 복사해 두면 다른 기기에서도 이어서 풀 수 있습니다.
